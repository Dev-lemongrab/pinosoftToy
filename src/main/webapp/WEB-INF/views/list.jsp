	...
	<%@ include file = "include/header.jsp"%>
		<div class="container">
			<form class="form-inline" action="/listView"method="post" >
				...
				<div class="form-group" style="height:58px;">
					<label>사번</label> <input type="text"class="form-control" id="sabun" name="sabun" >
					<label>성명</label> <input type="text"class="form-control" id="name" name="name" >
				...
				<div class="form-group">
					...
					<label>입사일자</label><input type = "text" class="form-control datepicker endDate" id="join_day" name="join_day" style="margin-left:8px;">
					<label>퇴사일자</label><input type ="text" class="form-control datepicker endDate" id="retire_day" name="retire_day" >							
					<label>직종분류</label><select class="form-control" id="job_type" name="job_type"><option></option></select>				
				</div>
		...
		<nav aria-label="Page navigation example" style ="text-align:center">
			  <ul class="pagination justify-content-center">
				<%-- <c:forEach var="" items="">	
				 	<li><a href="#" class="page" data-value=""></a></li>
			  	</c:forEach>  --%>
				 	<li><a href="#" class="page" data-value="">1</a></li>
			  </ul>
			</nav>
		</div>
