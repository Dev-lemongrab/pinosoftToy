...
<body>
	...
	<div class="container" style="height: 735px;">
		...
		<form class="form-inline" action="/input" method="post" onkeydown="return captureReturnKey(event)" style="width:1310px;" enctype="multipart/form-data">
			<div>
				...
				<div class="form-group"  style="float:right; padding-top:20px;" >
						...
						<input type="button" value="전화면" onclick="history.back()" class="form-control rightBut"> 
			...
			<!-- 첫번째 grid -->
				...
				<div class="grid" style="text-align: center;">
					<div class="form-group">
						<img class="" id="profile_image" name="profile_image" style ="width:165px; height:193px" src="upload/profile.jpg" >
					</div>
					<div class="form-group">
						<input type="file" class="form-control" id="profile_image_file" name="profile_image_file" accept="image/*" onchange="loadFile(this)">
					</div>
				<!-- 사진올리기 -->
					<div class="form-group">
					...
					<div class="form-group">
						<label>군별</label> <select class="form-control yn mil" id="mil_type" name="mil_type"><option></option></select>
					</div>
					<div class="form-group">
			...
			<!-- 세번째 grid -->
				<div class ="grid" style="width: 331px;">
					...
					<div class="form-group">
						<label>*패스워드</label> <input type="password" class="form-control" id="pwd" name="pwd" required="required" placeholder="">
					</div>
					<div class="form-group">
					...
					<label style="width:48px">*이메일</label> <input type="text" class="form-control" id="email1" name="email1" required="required" style="width:120px !important">
						&nbsp;&nbsp; <select class="form-control" id="email" name="email" style="width: 141px !important;"><option></option></select>
					</div>
					<div class="form-group">
						<input type="text" class="form-control" id="addr1" name="addr1" placeholder="주소" style="width:328px !important">
					</div>
					<div class="form-group">
